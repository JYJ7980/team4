...
<div class="row">
	...
	<div class="col-md-6 col-sm-8 hidden-xs">
		...
		<ul class="user-info pull-left pull-none-xsm"
			...
			<div style="font-size: 25px; font-weight: bold; color: #31271e;">
				GSITM 부트캠프 금융Project</div>
	...
	<div class="col-md-6 col-sm-4">
		...
		<ul class="list-inline links-list pull-right"
			...
			<li>
				<div>
					<span style="font-size: 18px; font-weight: bold; color: black;">${userInfoVO.dept} </span>&nbsp;
