					...
					<div class="flex flex-width-1000 flex-center">
						<div class="flex-wrap flex-66 flex flex-gap-10 flex-padding-10">
							<div class="form-group flex-50">
								<label class="form-control flex-20">가입대상:</label> <select
									class="form-control flex-80" v-model="possible_member">
							...
							<div class="form-group flex-50">
								<label class="form-control">상품유형:</label> <select
									class="form-control" v-model="product_type">
									<option value="">전체</option>
							...
							<div class="form-group flex-50">
								<label class="form-control">상품명:</label> <input
									class="form-control" v-model="product_name" value="" />
							</div>
							<div class="form-group flex-50">
						...
						methods : {
							...
							getList : function(isInit) {
								...
								cv_sessionStorage.setItem('pagingConfig',
										cv_pagingConfig).setItem('params',
										params);
