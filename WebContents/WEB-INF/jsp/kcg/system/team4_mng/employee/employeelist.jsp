                     ...
                     <div v-if="formChange1">
                        ...
                        <div class="mag-info">
                           ...
                           <div class="customer-info">
                              ...
                              <div v-if="key">
                              <div class="input-form">
                                 <label style="margin-left: 5px;">비밀번호 : </label> <input type="password" v-model="userPw" style="margin-left: 10px; ">
                     ...
                     <h3 style="margin-left: 150px; margin-top: 50px;">신규 직원</h3>
                        <div class="mag-info">
                           <div class="customer-info">
                              ...
                              <div class="input-form">
                                 <label style="margin-left: 32px;">이름 : </label> <input type="text"
                                    v-model="newEmployee.new_name" style="margin-left: 10px;">
                              </div>

                              <div class="input-form">
                                 <label style="margin-left: -28px;">초기 비밀번호 : </label> <input type="text"
